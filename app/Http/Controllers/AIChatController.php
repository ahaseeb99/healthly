...
class AIChatController extends Controller
{
	...
	private function openaiChatStream($request, $openaiApiKey, $chat_bot, $history,  $message_id , $ai_max_tokens = null, $images = []){
		return response()->stream(function () use ($request, $openaiApiKey,$ai_max_tokens, $history, $chat_bot, $message_id ,$images) {
