@php
    ...
    } elseif (view()->hasSection('titlebar_title')) {
...
>
    <div {{ $attributes->twMergeFor('container', $container_base_class) }}>
        ...
        <div class="lqd-titlebar-col lqd-titlebar-col-actions group/titlebar-actions flex w-full flex-wrap lg:w-5/12 lg:justify-end">
