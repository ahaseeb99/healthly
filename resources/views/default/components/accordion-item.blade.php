<div class="lqd-accordion-item group" style="background-color: #E9E2FE; padding: 25px; border-bottom: 2px solid white; border-radius: 15px;">
	<button data-target="#{{$id}}" data-trigger-type="accordion" class="flex items-center justify-between w-full py-5 pl-4 text-heading-foreground text-left text-[20px] font-normal tracking-wide border-b group/btn group-last:border-b-0">
		...
		<div class="inline-flex items-center justify-center ml-3 border w-7 h-7 rounded-3xl shrink-0">
			<span class="group-[&.lqd-is-active]/btn:hidden" style="background-color: rgba(255, 255, 255, 0.2); padding: 10px; border-radius: 30px; box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.15);">
			...
			<span class="hidden group-[&.lqd-is-active]/btn:block" style="background-color: rgba(255, 255, 255, 0.5); padding: 10px; border-radius: 30px; box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.15);">
				<svg width="7" height="2" viewBox="0 0 7 2" fill="black" xmlns="http://www.w3.org/2000/svg">
