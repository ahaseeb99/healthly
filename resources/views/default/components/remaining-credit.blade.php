@php
    ...
    $progressbar_text_base_class = 'lqd-progress-bar shrink-0 grow-0 basis-auto prgress-bar-primary';
    $progressbar_image_base_class = 'lqd-progress-bar shrink-0 grow-0 basis-auto prgress-bar-secondary';
...
<div {{ $attributes->withoutTwMergeClasses()->twMerge($base_class, $attributes->get('class')) }}>
    <div @class([
        ...
        <x-legend
            ...
            label="{{ __('Words') }}"
        >
            <span class="font-medium ms-auto" style="color: white;">
        ...
        <x-legend
            ...
            label="{{ __('Images') }}"
        >
            <span class="font-medium ms-auto">
