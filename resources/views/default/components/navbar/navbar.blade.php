...
>
    <div class="h-full overflow-y-auto lqd-navbar-inner -me-navbar-me overscroll-contain pe-navbar-pe ps-navbar-ps">
        <div
            ...
            >
                ...
                <img
                    ...
                    src="/public/images/healthly_admin_short.svg"
                    alt="{{ $setting->site_name }}"
                >
                <img
        ...
        >
            <ul class="lqd-navbar-ul">
                ...
                @if ($setting->feature_affilates)
                    ...
                    <x-navbar.item class="pb-navbar-link-pb pe-navbar-link-pe ps-navbar-link-ps pt-navbar-link-pt group-[&.navbar-shrinked]/body:hidden">
                        <div
                            class="inline-block w-full px-8 py-4 leading-tight text-center border lqd-navbar-affiliation rounded-xl border-navbar-divider text-2xs transition-border">
