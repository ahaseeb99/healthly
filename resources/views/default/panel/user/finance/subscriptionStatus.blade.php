...
@if ($team)
    <x-card
        ...
        szie="lg"
    >
        <div class="flex flex-wrap items-center justify-between text-base font-medium leading-normal gap-y-4">
            ...
            <div class="w-full ms-auto md:w-1/2">
                <div class="relative">
...
@else
    <x-card
        class:body="flex flex-wrap justify-between x-card"
        size="lg"
    >
        ...
        <div class="w-full ms-auto lg:w-1/2">
            <div class="relative">
