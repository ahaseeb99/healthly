...
@section('form')
    @if ($setting->register_active == 1)
        <div class="container-tight">
            <h1 class="mb-11 sign-text">{{ __('Sign up') }}</h1>
            ...
            >
                ...
                @if ($setting->privacy_enable == 1 && $setting->privacy_enable_login == 1)
                    <div class="text-foreground/70 sign-text">
                        I confirm that I have read and agree to the <a href="/page/custom-terms-and-conditions">Terms and Conditions</a> and <a href="/page/custom-privacy-notice">Privacy Notice.</a>
                    </div>
                @endif
            </form>
        </div>
...
function checkCountry() {
    var country = document.getElementById('country_register').value;
    var button = document.getElementById('RegisterFormButton');
    button.disabled = !country;  // If no country is selected, disable the button
}
checkCountry(null)
</script>
@endsection
