    ...
    <div class="w-full space-y-9">
        ...
        >
            <div class="flex w-full flex-wrap justify-between gap-y-5 lg:w-[48%]">
                ...
                @if (\App\Models\Gateways::query()->where('code', 'coingate')->count() || \App\Models\Gateways::query()->where('code', 'razorpay')->count())
                    <x-alert class="mb-2 mt-3">
                        <p>
                            {{ __('Congate or Razorpay subscriptions require you to set up cron jobs on your server. You can find detailed instructions in ') }}
                            <a
                                class="underline"
