<div class="w1/3 group cursor-pointer pb-[16px] pt-9 text-center text-[15px] font-medium">
    ...
    <div class="whitespace-nowrap opacity-0 transition-all group-[&.is-nav-selected]:opacity-100" style="color: white">
        <p class="text-heading-foreground" style="color: white">{!! __($item->full_name) !!}</p>
        <p class="text-heading-foreground opacity-15" style="color: white">{!! __($item->job_title) !!}</p>
    </div>
</div>
