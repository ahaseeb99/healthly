...
<footer class="site-footer relative bg-black pt-40 text-white">
    <div
        class="absolute inset-0"
        style="background: url('{{asset('public/images/bg/Frame 49.png')}}'); background-repeat: no-repeat; background-size: cover;"
    >
    </div>
    ...
    <div class="relative">
        <div class="container mb-28">
            <div class="w-1/2 text-center max-lg:w-10/12 max-sm:w-full" style="width: 40%;">
               
                <div class="flex w-[305px] items-center gap-5 text-sm mb-2"  style="justify-content: center;">
                    
                    <p class="">
                        {{ __($setting->site_name) }}<span class=" inline-flex shrink-0 items-center justify-center rounded-xl" style="width: 25px; height: auto;">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M0.39873 15.996C4.02258 15.3579 7.72759 13.4646 10.7933 10.3988C13.859 7.33311 15.7524 3.62807 16.3904 0.00419829C12.7666 0.64228 9.06157 2.5356 5.99586 5.60131C2.93012 8.66705 1.0368 12.3721 0.39873 15.996Z" fill="#D7C9FF"/>
                    ...
                    </span> {{ __($fSetting->footer_text_small) }}</p>
                </div>
                <p
                    class="-from-[5%] text-left mb-8 bg-gradient-to-br from-transparent to-white to-50% bg-clip-text font-heading text-[100px] font-bold leading-none max-sm:text-[18vw]" style="font-size: 50px">
                    {{ __($fSetting->footer_header) }}
                </p>
                <p class="mb-9 text-left font-heading text-[20px] font-normal leading-[1.25em] opacity-50">
                    {{ __($fSetting->footer_text) }}
                </p>
            </div>
            <div class="w-full text-center max-lg:w-10/12 max-sm:w-full">
                <a
                        style="background-color: rgb(0 0 0 / 50%); padding: 1rem 5rem 1rem 5rem; font-size: 18px; letter-spacing: 1px;"
                    ...
                    >
                        <span class="relative z-10 inline-flex items-center">
                            <img src="{{asset('public/images/bg/pik.png')}}" alt="Forest" width="12" height="12" style="float:left;margin-right:14px">
                            {!! __($fSetting->hero_button) !!}
                            
                         
                                 <img src="{{asset('public/images/bg/pik.png')}}" alt="Forest" width="12" height="12" style="float:left;margin-left:11px">
                        </span>
                    </a>
            </div>
        </div>
        <div class="mt-9 flex justify-center">
                <div class="flex items-center gap-5 text-sm text-[#002A40] text-opacity-60" style="justify-content: center; margin-bottom: 100px;">
    ...
    margin-right: 20px;">
                       Safe Payment
                         ...
                         <img src="/public/images/mc.png" alt="Master Card" style="display: inline;
    flex-shrink: 0;
    width: 64px;
    height: 44px;
    position: relative;
    top: -6px;
    margin-right: 20px;">
                                           <img src="/public/images/visa.png" alt="Visa" style="    width: 100px;
    height: 32px;"></div>
                </div>
            </div>
        <div class="container">
    ...
    font-size: 14px;
    margin-bottom: -45px;">
                <a href="https://healthly.live/page/custom-terms-and-conditions" style="
    margin-right: 15px;
">Terms &amp; Conditions</a>
                <a href="https://healthly.live/page/custom-privacy-notice"  style="
    margin-right: 15px;
">Privacy Notice</a>
<a href="https://healthly.live/page/custom-cookie-notice"  style="
    margin-right: 15px;
">Cookie Notice</a>
            </div>
            <div class="flex flex-wrap items-center justify-between gap-8 pb-7 pt-10 max-sm:justify-center">
                ...
                <p class="!text-end text-[14px] opacity-60" style="
    max-width: 400px;
    text-align: center !important;
">{{ __($fSetting->footer_copyright) }}</p>
            </div>
